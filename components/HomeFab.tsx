...
const HomeFab: React.FC<HomeFabProps> = ({ visible, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      aria-label="Go home"
      className="fixed bottom-6 inset-x-0 mx-auto w-16 h-16 bg-gradient-to-br from-purple-500 to-fuchsia-500 rounded-full shadow-xl shadow-purple-200 flex items-center justify-center text-white text-2xl z-40 active:scale-95 transition-transform"
